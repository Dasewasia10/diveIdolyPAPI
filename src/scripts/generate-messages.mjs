...
// --- MAPPING DATA ---
const charIdToName = {
  "char-mna": "Mana Nagase",
  "char-ktn": "Kotono Nagase",
  "char-skr": "Sakura Kawasaki",
  "char-rei": "Rei Ichinose",
  "char-ngs": "Nagisa Ibuki",
  "char-hrk": "Haruko Saeki",
  "char-ski": "Saki Shiraishi",
  "char-suz": "Suzu Narumiya",
  "char-mei": "Mei Hayasaka",
  "char-szk": "Shizuku Hyodo",
  "char-rui": "Rui Tendo",
  "char-yu": "Yu Suzumura",
  "char-smr": "Sumire Okuyama",
  "char-rio": "Rio Kanzaki",
  "char-aoi": "Aoi Igawa",
  "char-ai": "Ai Komiyama",
  "char-kkr": "Kokoro Akazaki",
  "char-chs": "Chisa Shiraishi",
  "char-mhk": "Miho",
  "char-kan": "Kana",
  "char-kor": "Fran",
  "char-cca": "Cocoa",
...
const syncMessages = async () => {
  ...
  try {
    ...
    console.log(
      `Loaded ${rawGroups.length} Groups and ${rawMessages.length} Messages.`,
    );
        ...
        const detailPayload = {
          ...
          details: rawDetails.map((d) => {
            ...
            return {
              ...
              stamp: d.stampAssetId
                ? `${R2_DOMAIN}/stampChat/stamp_${d.stampAssetId}.webp`
                : null,
              image: d.imageAssetId
                ? `${R2_DOMAIN}/messagePictures/img_message_picture_${d.imageAssetId}.png`
                : null,
